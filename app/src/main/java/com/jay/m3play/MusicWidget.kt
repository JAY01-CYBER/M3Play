...
class MusicWidget : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.jay.m3play.ACTION_PLAY_PAUSE"
        const val ACTION_PREV = "com.jay.m3play.ACTION_PREV"
        const val ACTION_NEXT = "com.jay.m3play.ACTION_NEXT"
        const val ACTION_SHUFFLE = "com.jay.m3play.ACTION_SHUFFLE"
        const val ACTION_LIKE = "com.jay.m3play.ACTION_LIKE"
        const val ACTION_REPLAY = "com.jay.m3play.ACTION_REPLAY"
        const val ACTION_OPEN_APP = "com.jay.m3play.ACTION_OPEN_APP"
        const val ACTION_STATE_CHANGED = "com.jay.m3play.ACTION_STATE_CHANGED"
        const val ACTION_UPDATE_PROGRESS = "com.jay.m3play.ACTION_UPDATE_PROGRESS"
